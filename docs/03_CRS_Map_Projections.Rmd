...
the CRSs of our two sf objects are different! **This explains why we couldn't overlay them correctly!**


The above CRS definition for `states_limited` specifies a bunch of information, including:
...
Let's transform the states data to Web Mercator (3857), giving the output dataframe a name that will make the CRS obvious to us. This can be very helpful when working with multiple copies of a spatial dataframe.
```{r}
