...
```{r}
st_write(alameda_county, "outdata/alameda_county.geojson", delete_dsn = T)
#or
...
```{r}
st_write(alameda_county, "outdata/alameda_county.gpkg", delete_dsn=T)
```
...
```{r}
st_write(alameda_county, "outdata/alameda_county.csv", layer_options="GEOMETRY=AS_WKT", delete_dsn=T)
```
