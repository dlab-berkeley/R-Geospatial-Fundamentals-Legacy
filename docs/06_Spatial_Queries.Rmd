...
- <u>Spatial Measurement Queries</u>
    ...
    - What is feature A's **perimeter**?
      - *What is the perimeter of the city of Berkeley?*
...
An important distinction between these two types of queries is that measurement queries **always depend** on the CRS of the data while spatial relationship queries almost always do not. 
