...
```{r, eval=F}
our_packages<- c("ggplot2", "ggmap", "sf", "units", "tmap", "raster")
...
(The API key will be different in each workshop. See `tmp_key.txt`. But the code should look something like the following.)
